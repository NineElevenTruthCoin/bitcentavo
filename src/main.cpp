...
uint256 hashGenesisBlock("0x000000008d6bd178f70480f737248f0cfa05f560b0ada8e6177e62efe13f1bdf");
...
const string strMessageMagic = "BITCENTAVO Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000008d6bd178f70480f737248f0cfa05f560b0ada8e6177e62efe13f1bdf");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1401357184;
        block.nBits    = 486604799;
        block.nNonce   = 522408577;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BITCENTAVOMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BITCENTAVOMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BITCENTAVOMiner started\n");
    ...
    try { loop {
        ...
        printf("Running BITCENTAVOMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BITCENTAVOMiner terminated\n");
        throw;
    }
}
